        ...
        if (\Auth::user()->can('create user')) {
            ...
            $projectPermission =[
                ...
                $HRPermission =[
                    ...
                    ['name' => 'manage assets type'],
                    ['name' => 'create assets type'],
                    ['name' => 'edit assets type'],
                    ['name' => 'delete assets type'],
                    ['name' => 'manage assets management'],
                    ['name' => 'create assets management'],
                    ['name' => 'edit assets management'],
                    ['name' => 'delete assets management'],
                    ['name' => 'assign assets management'],
