...
@if ($settings['home_status'] == 'on')
    <section class="main-banner bg-info" id="home">
                        ...
                        <div class="row align-items-center justify-content-center mb-4">
                            <div class="col-lg-4 col-md-6">
                                <div class="title mb-4">
                                    ...
                                    <h2>
                                        TZI SaaS All In One Business ERP With Project, Account, HRM, CRM & POS
                                    </h2>
                                </div>
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        <p class="mb-0"> &copy;
            {{ date('Y') }}
            {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'TZI') }}
        </p>
