        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    ...
                    >
                    <a href="https://codecanyon.net/item/TZI-saas-all-in-one-business-erp-with-project-account-hrm-crm/33263426" class="btn btn-outline-light" target="_blank"
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 text-end">
                ...
                <p class="text-body">Copyright © 2023 | Design By TZI</p>
            </div>
        </div>
    </div>
</section>
