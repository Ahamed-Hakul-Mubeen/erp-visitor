<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('currency.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'currency.index' ) ? 'active' : '' }}   ">{{__('Currency List')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
        <a href="{{ route('exchange_rate.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'exchange_rate.index' ) ? 'active' : '' }}   ">{{__('Exchange Rate')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
