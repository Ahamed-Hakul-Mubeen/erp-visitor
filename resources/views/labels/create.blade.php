...
<div class="modal-body">
    <div class="row">
        <div class="form-group col-12">
            {{ Form::label('name', __('Label Name'),['class'=>'form-label']) }}<span class="text-danger">*</span>
        ...
        <div class="form-group col-12">
            {{ Form::label('name', __('Color'),['class'=>'form-label']) }}<span class="text-danger">*</span>
            <div class="row gutters-xs">
                @foreach($colors as $color)
                    <div class="col-auto">
                        <label class="colorinput">
                            <input name="color" type="radio" value="{{$color}}" class="colorinput-input" @if($loop->first) checked @endif>
