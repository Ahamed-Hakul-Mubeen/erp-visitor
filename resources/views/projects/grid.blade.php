                                    ...
                                    @foreach($project->users as $key => $user)
                                        @if($key < 3)
                                            <a href="#" class="avatar rounded-circle avatar-sm">
                                                <img @if($user->avatar) src="{{ Storage::url('uploads/avatar/'.$user->avatar) }}" @else src="{{ Storage::url('uploads/avatar/avatar.png') }}" @endif  alt="image" data-bs-toggle="tooltip" title="{{ $user->name }}">
                                            </a>
                                        @else
                                            @break
                                        @endif
