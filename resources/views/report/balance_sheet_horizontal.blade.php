                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="border-start border-end">
                                        ...
                                        @if ($accounts != [] && $type != 'Assets')
                                            <div class="py-2 account-main-inner">
                                                        ...
                                                        @foreach ($records as $key => $record)
                                                            @if ($record['account'] == 'parentTotal')
                                                                <div
                                                                    ...
                                                                    <p
                                                                        class="mb-2 text-primary float-end text-end me-3">
                                                            ...
                                                            @if ($record['account'] == 'parent' || $record['account'] == 'parentTotal')
                                                                <div
                                                                    ...
                                                                    <p class="mb-2 text-center ms-3">
                                                                        {{ $record['account_code'] }}</p>
                                                                    <p
                                                                        class="mb-2 text-dark fw-bold float-end text-end me-3">
                                                                        {{ \Auth::user()->priceFormat($record['netAmount']) }}
                                                                    </p>
                                                                </div>
                                                            @endif
                                                ...
                                                <div
                                                    ...
                                                    <h6 class="mb-0 fw-bold text-end me-3">
                                    ...
                                    @if ($totalAmount != 0)
                                        <div
                                            class="px-0 py-2 d-flex align-items-center justify-content-between border-bottom">
                                            <h6 class="mb-0 fw-bold ms-2">{{ 'Total for Liabilities & Equity' }}</h6>
                                            <h6 class="mb-0 fw-bold text-end me-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="border-start border-end">
                                    ...
                                    @if ($totalAmounts != 0)
                                        <div
                                            class="px-0 py-2 d-flex align-items-center justify-content-between border-bottom">
                                            <h6 class="mb-0 fw-bold ms-2">{{ 'Total for Assets' }}</h6>
                                            <h6 class="mb-0 fw-bold text-end me-3">
