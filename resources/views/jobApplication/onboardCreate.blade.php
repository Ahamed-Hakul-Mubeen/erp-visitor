    ...
    <div class="row">
        @if ($id == 0)
            <div class="form-group col-md-12">
                {{ Form::label('application', __('Interviewer'), ['class' => 'col-form-label']) }}<span class="text-danger">*</span>
        ...
        <div class="form-group col-md-12">
            ...
            {!! Form::date('joining_date', null, ['class' => 'form-control ','autocomplete'=>'off','min' => \Carbon\Carbon::today()->format('Y-m-d'),'required' => 'required']) !!}
        </div>
        ...
        <div class="form-group col-md-6">
            {{ Form::label('job_type', __('Job Type'), ['class' => 'col-form-label']) }}<span class="text-danger">*</span>
