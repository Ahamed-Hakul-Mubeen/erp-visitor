...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-lg-6 col-md-6">
            ...
            {{Form::text('purpose_of_visit',null,array('class'=>'form-control' , 'placeholder'=>__('Enter Purpose of Visit')))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('place_of_visit',__('Country'),['class'=>'form-label'])}}
            {{Form::text('place_of_visit',null,array('class'=>'form-control' ,'placeholder'=>__('Enter Place of Visit')))}}
        </div>
        <div class="form-group col-md-12">
