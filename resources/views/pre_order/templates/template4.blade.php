...
<div class="pre_order-preview-main" id="boxes">
    <div class="pre_order-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 30px; font-weight: bold; margin-bottom: 10px; color: {{ $color }};">{{ __('Pre Order') }}</h3>
                    <p>
    ...
    <div class="pre_order-body">
        ...
        <table class=" pre_order-summary" style="margin-top: 30px;">
