...
<div class="pre_order-preview-main" id="boxes">
    <div class="pre_order-header">
        <table class="vertical-align-top">
            <tbody>
            <tr>
                <td >
                    <h3 style=" display: inline-block; text-transform: uppercase; font-size: 40px; font-weight: bold; border-top: 5px solid var(--theme-color); padding-top: 5px;">{{__('Pre Order')}}</h3>
                ...
                <td class="text-right">
                    <img class="pre_order-logo" src="{{$img}}" alt="">
                </td>
