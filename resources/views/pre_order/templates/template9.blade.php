...
<div class="pre_order-preview-main" id="boxes" style="border-right:40px solid var(--theme-color);">
    <div class="pre_order-header">
        <table>
            <tbody>
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: var(--theme-color); margin-bottom: 10px;">{{__('pre_order')}}</h3>
    ...
    <div class="pre_order-body" style="padding-right: 0;">
        <table class="add-border pre_order-summary">
