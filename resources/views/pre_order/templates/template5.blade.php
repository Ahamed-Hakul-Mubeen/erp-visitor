                        ...
                        <td>
                            ...
                            <div class="view-qrcode" style="margin-left: 0; margin-bottom: 15px; ">
                                {!! DNS2D::getBarcodeHTML(
                                    route('pre_order.link.copy', \Crypt::encrypt($pre_order->pre_order_id)),
                                    'QRCODE',
                                    2,
                                    2,
                                ) !!}
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td>{{ __('Number') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::preOrderNumberFormat($settings, $pre_order->pre_order_id) }}</td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Issue Date') }}:</td>
                                        <td class="text-right">
                                            {{ Utility::dateFormat($settings, $pre_order->issue_date) }}</td>
                                    </tr>
                                    ...
                                    @if (!empty($customFields) && count($pre_order->customField) > 0)
                                        @foreach ($customFields as $field)
                                            <tr>
                                                <td>{{ $field->name }} :</td>
                                                <td> {{ !empty($pre_order->customField) ? $pre_order->customField[$field->id] : '-' }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                    ...
                    <tr>
                        ...
                        <td colspan="2" class="sub-total">
                            <table class="total-table">
                                ...
                                <tr style="border-bottom:1px solid {{ $color }};">
                                    <td>{{ __('Total') }}:</td>
                                    <td>{{ Utility::priceFormat($settings, $pre_order->getSubTotal() - $pre_order->getTotalDiscount() + $pre_order->getTotalTax()) }}
                                    </td>
                                </tr>
