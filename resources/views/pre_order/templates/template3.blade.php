...
<div class="pre_order-preview-main"  id="boxes">
    <div class="pre_order-header" style="">
        <table class="vertical-align-top">
            ...
            <tr>
                <td>
                    <h3 style="text-transform: uppercase; font-size: 20px; font-weight: bold; color: {{$color}};">{{__('Pre Order')}}</h3>
    ...
    <div class="pre_order-body">
        ...
        <table class=" pre_order-summary" style="border-bottom:1px solid {{$color}};">
