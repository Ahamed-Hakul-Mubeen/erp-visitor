...
{{--                                </div>--}}
        ...
        <div class="col-12">
            ...
            <div class="float-end p-1">
                <a href="#" data-size="lg" data-url="{{ route('productservice.create',['from_preorder' => 1]) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create New Product')}}" class="btn btn-sm btn-primary">
